...
class TTSService:
    ...
    def text_file_to_speech(self, source_path: str, output_path: str, *, alignment: bool | None = None, lang: str = "es") -> None:
        """Generate time-aligned TTS audio from a translated JSON transcript."""
        tts_text_file_to_speech(source_path, output_path, self.tts_engine, alignment=alignment, lang=lang)
