...
class TTSService:
    ...
    def text_file_to_speech(self, source_path: str, output_path: str, *, alignment: bool | None = None, lang: str = "es", speaker_wav: str | None = None) -> None:
        """Generate time-aligned TTS audio from a translated JSON transcript."""
        tts_text_file_to_speech(source_path, output_path, self.tts_engine, alignment=alignment, lang=lang, speaker_wav=speaker_wav)
